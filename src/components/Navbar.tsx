...
const Navbar = () => {
  ...
  return (
    <nav className='fixed z-20 flex items-center justify-between w-full p-2 border border-t-0 border-l-0 border-r-0 border-gray-300 bg-white text-[#444] dark:bg-[#333] dark:text-white' id='nav'>
